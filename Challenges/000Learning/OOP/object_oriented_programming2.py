...
print(item1.calculate_total_price())  # (self, x, y) == (item1, price, quantity)

item2 = Item('Laptop', 1000, 3)
item2.has_numpad = False
item2.pay_rate = 0.7  #  if I want a 30% discount on the laptop
print(item2.calculate_total_price())



print(Item.__dict__) #  return all attributes at class level
print(item1.__dict__) #  return all attributes at instance level

item1.apply_discount()
print(item1.price)

item2.apply_discount()
print(item2. price)  #  returns 700 because the method we constructed has self.pay_rate
                     #  this way, it searches for the attribute pay_rate within class 1st
